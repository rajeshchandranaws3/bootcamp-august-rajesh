...
def lambda_handler(event, context):
    ...
    subject = "Lambda Function: Daily Automated cloud report"
    body = f"""
            HI All,
    ...
    print(f"Print Success: Email sent with message id: {message_id}")

    return {    
        'statusCode': 200,
        'body': json.dumps(f'Return Success: Email sent with message id: {message_id}')
    }