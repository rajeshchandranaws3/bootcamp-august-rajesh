...
def build_email(to_email, from_email, subject, body, attachment_file):
...
def run():
    ...
    from_email = 'rajeshchandranaws3@gmail.com'
    to_email = ['rajeshchandran007@gmail.com']
    subject = "Lambda: Daily Automated cloud report"
    body = f"""
            HI All,
            Please find today's cloud roport.
    ...
    msg = build_email(to_email, from_email, subject, text_body, attachment_name)
    
    message_id = send_email(from_email, to_email, msg)
